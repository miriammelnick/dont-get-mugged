...
class DeleteFoodLogInputSet(InputSet):
        """
        Set the value of the FoodLogId input for this choreography. ((integer) The id of the food log you want to delete. The Id is returned in the LogFood response.)
        """
