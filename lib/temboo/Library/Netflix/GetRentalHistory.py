...
class GetRentalHistory(Choreography):

    """
    Create a new instance of the GetRentalHistory Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Netflix/GetRentalHistory')


    def new_input_set(self):
        return GetRentalHistoryInputSet()

    def _make_result_set(self, result, path):
        return GetRentalHistoryResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetRentalHistoryChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the GetRentalHistory
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class GetRentalHistoryInputSet(InputSet):
        """
        ...
        """
        Set the value of the UserID input for this choreography. ((required, string) The ID associated with the user whose rental history you want to retrieve.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetRentalHistory choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class GetRentalHistoryResultSet(ResultSet):
        """
...
class GetRentalHistoryChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetRentalHistoryResultSet(response, path)
