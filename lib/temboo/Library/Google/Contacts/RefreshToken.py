...
class RefreshToken(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Contacts/RefreshToken')
...
class RefreshTokenInputSet(InputSet):
        """
        Set the value of the ClientIdD input for this choreography. ((required, string) The client ID provided by Google when you sign up for an account.)
        """
        def set_ClientIdD(self, value):
            InputSet._set_input(self, 'ClientIdD', value)
