...
class GetActiveChannelsInputSet(InputSet):
        """
        Set the value of the ChannelService_Type input for this choreography. ((string) One of 'Url' or 'Custom'.)
        """
        def set_ChannelService_Type(self, value):
            InputSet._set_input(self, 'ChannelService_Type', value)

        """
        Set the value of the ClientID input for this choreography. ((string) The ID of the publisher to get active channels of.)
        """
