...
class SetUsersPreferredLocaleInputSet(InputSet):
        """
        Set the value of the ClientID input for this choreography. ((string) The ID of the publisher to set the local preference for.)
        """
        ...
        """
        Set the value of the UsersPreferredLocale input for this choreography. ((string) The user's preferred locale (language), e.g. 'en' for English.)
        """
