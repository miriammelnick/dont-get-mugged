...
class ClientLoginAuthenticationInputSet(InputSet):
        ...
        """
        Set the value of the Service input for this choreography. ((string) The service that you are requesting an authorization token for. Defaults to 'wise' for Spreadsheets API.)
        """
